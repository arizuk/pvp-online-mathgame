...
_COMMAND_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="JOIN_ROOM", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="START_GAME", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ANSWER", index=2, number=2, serialized_options=None, type=None
        ),
    ],
...
_COMMAND = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="player_id",
            full_name="mathgame.protobuf.Command.player_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start_game",
            full_name="mathgame.protobuf.Command.start_game",
            index=2,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="answer",
            full_name="mathgame.protobuf.Command.answer",
            index=3,
            number=11,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="payload",
            full_name="mathgame.protobuf.Command.payload",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_STARTGAME = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="num_problems",
            full_name="mathgame.protobuf.StartGame.num_problems",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_ANSWER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="answer",
            full_name="mathgame.protobuf.Answer.answer",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_COMMAND.oneofs_by_name["payload"].fields.append(_COMMAND.fields_by_name["start_game"])
_COMMAND.fields_by_name["start_game"].containing_oneof = _COMMAND.oneofs_by_name[
    "payload"
]
_COMMAND.oneofs_by_name["payload"].fields.append(_COMMAND.fields_by_name["answer"])
...
StartGame = _reflection.GeneratedProtocolMessageType(
    "StartGame",
    (_message.Message,),
    {
