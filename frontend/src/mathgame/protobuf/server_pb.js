...
goog.exportSymbol('proto.mathgame.protobuf.ProblemResult', null, global);
 ...
 * @constructor
 */
proto.mathgame.protobuf.ProblemResult = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mathgame.protobuf.ProblemResult.repeatedFields_, null);
};
goog.inherits(proto.mathgame.protobuf.ProblemResult, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mathgame.protobuf.ProblemResult.displayName = 'proto.mathgame.protobuf.ProblemResult';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.mathgame.protobuf.Response.oneofGroups_ = [[10,11,12,13,14]];
...
proto.mathgame.protobuf.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    problemResult: (f = msg.getProblemResult()) && proto.mathgame.protobuf.ProblemResult.toObject(includeInstance, f),
...
proto.mathgame.protobuf.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      ...
      break;
    case 13:
      var value = new proto.mathgame.protobuf.ProblemResult;
      reader.readMessage(value,proto.mathgame.protobuf.ProblemResult.deserializeBinaryFromReader);
      msg.setProblemResult(value);
      break;
    case 14:
...
proto.mathgame.protobuf.Response.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getProblemResult();
  if (f != null) {
    writer.writeMessage(
      13,
      f,
      proto.mathgame.protobuf.ProblemResult.serializeBinaryToWriter
    );
  }
...
/**
 * optional ProblemResult problem_result = 13;
 * @return {?proto.mathgame.protobuf.ProblemResult}
 */
proto.mathgame.protobuf.Response.prototype.getProblemResult = function() {
  return /** @type{?proto.mathgame.protobuf.ProblemResult} */ (
    jspb.Message.getWrapperField(this, proto.mathgame.protobuf.ProblemResult, 13));
};


/**
 * @param {?proto.mathgame.protobuf.ProblemResult|undefined} value
 * @return {!proto.mathgame.protobuf.Response} returns this
*/
proto.mathgame.protobuf.Response.prototype.setProblemResult = function(value) {
  return jspb.Message.setOneofWrapperField(this, 13, proto.mathgame.protobuf.Response.oneofGroups_[0], value);
};
 ...
 * @return {!proto.mathgame.protobuf.Response} returns this
 */
proto.mathgame.protobuf.Response.prototype.clearProblemResult = function() {
  return this.setProblemResult(undefined);
};
 ...
 * @return {boolean}
 */
proto.mathgame.protobuf.Response.prototype.hasProblemResult = function() {
 ...
 * @const
 */
proto.mathgame.protobuf.ProblemResult.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.mathgame.protobuf.ProblemResult.prototype.toObject = function(opt_includeInstance) {
  return proto.mathgame.protobuf.ProblemResult.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mathgame.protobuf.ProblemResult} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mathgame.protobuf.ProblemResult.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.mathgame.protobuf.ProblemResult}
 */
proto.mathgame.protobuf.ProblemResult.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mathgame.protobuf.ProblemResult;
  return proto.mathgame.protobuf.ProblemResult.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mathgame.protobuf.ProblemResult} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mathgame.protobuf.ProblemResult}
 */
proto.mathgame.protobuf.ProblemResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mathgame.protobuf.ProblemResult.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mathgame.protobuf.ProblemResult.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mathgame.protobuf.ProblemResult} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mathgame.protobuf.ProblemResult.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.mathgame.protobuf.ProblemResult.prototype.getPlayerScoresList = function() {
  return /** @type{!Array<!proto.mathgame.protobuf.PlayerScore>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mathgame.protobuf.PlayerScore, 1));
};


/**
 * @param {!Array<!proto.mathgame.protobuf.PlayerScore>} value
 * @return {!proto.mathgame.protobuf.ProblemResult} returns this
*/
proto.mathgame.protobuf.ProblemResult.prototype.setPlayerScoresList = function(value) {
 ...
 */
proto.mathgame.protobuf.ProblemResult.prototype.addPlayerScores = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.mathgame.protobuf.PlayerScore, opt_index);
};
 ...
 * @return {!proto.mathgame.protobuf.ProblemResult} returns this
 */
proto.mathgame.protobuf.ProblemResult.prototype.clearPlayerScoresList = function() {
