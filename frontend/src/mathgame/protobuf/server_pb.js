...
goog.exportSymbol('proto.mathgame.protobuf.Binary', null, global);
 ...
 * @constructor
 */
proto.mathgame.protobuf.Binary = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mathgame.protobuf.Binary, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.mathgame.protobuf.Binary.displayName = 'proto.mathgame.protobuf.Binary';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.mathgame.protobuf.Problem.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    binary: (f = msg.getBinary()) && proto.mathgame.protobuf.Binary.toObject(includeInstance, f)
  };
...
proto.mathgame.protobuf.Problem.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 10:
      var value = new proto.mathgame.protobuf.Binary;
      reader.readMessage(value,proto.mathgame.protobuf.Binary.deserializeBinaryFromReader);
      msg.setBinary(value);
      break;
    default:
      reader.skipField();
...
proto.mathgame.protobuf.Problem.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.mathgame.protobuf.Binary.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Binary binary = 10;
 * @return {?proto.mathgame.protobuf.Binary}
 */
proto.mathgame.protobuf.Problem.prototype.getBinary = function() {
  return /** @type{?proto.mathgame.protobuf.Binary} */ (
    jspb.Message.getWrapperField(this, proto.mathgame.protobuf.Binary, 10));
};


/**
 * @param {?proto.mathgame.protobuf.Binary|undefined} value
 * @return {!proto.mathgame.protobuf.Problem} returns this
*/
proto.mathgame.protobuf.Problem.prototype.setBinary = function(value) {
 ...
 * @return {!proto.mathgame.protobuf.Problem} returns this
 */
proto.mathgame.protobuf.Problem.prototype.clearBinary = function() {
 ...
 * @return {boolean}
 */
proto.mathgame.protobuf.Problem.prototype.hasBinary = function() {
  return jspb.Message.getField(this, 10) != null;
};
 ...
 * @return {!Object}
 */
proto.mathgame.protobuf.Binary.prototype.toObject = function(opt_includeInstance) {
  return proto.mathgame.protobuf.Binary.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mathgame.protobuf.Binary} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mathgame.protobuf.Binary.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.mathgame.protobuf.Binary}
 */
proto.mathgame.protobuf.Binary.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mathgame.protobuf.Binary;
  return proto.mathgame.protobuf.Binary.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mathgame.protobuf.Binary} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mathgame.protobuf.Binary}
 */
proto.mathgame.protobuf.Binary.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mathgame.protobuf.Binary.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mathgame.protobuf.Binary.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mathgame.protobuf.Binary} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mathgame.protobuf.Binary.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getX();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.mathgame.protobuf.Binary.prototype.getX = function() {
...
/**
 * @param {number} value
 * @return {!proto.mathgame.protobuf.Binary} returns this
 */
proto.mathgame.protobuf.Binary.prototype.setX = function(value) {
 ...
 * @return {number}
 */
proto.mathgame.protobuf.Binary.prototype.getY = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.mathgame.protobuf.Binary} returns this
 */
proto.mathgame.protobuf.Binary.prototype.setY = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
